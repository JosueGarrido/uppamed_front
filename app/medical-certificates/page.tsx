  ...
  const handleEditCertificate = async (certificate: MedicalCertificate) => {
    try {
      ...
      setFormData({
        ...
        patient_age: fullCertificate.patient_age?.toString() ?? '',
        ...
        contingency_type: fullCertificate.contingency_type ?? 'Enfermedad general',
  ...
  const handleSubmit = async () => {
    try {
      ...
      const certificateData = {
        ...
        contingency_type: formData.contingency_type as 'Enfermedad general' | 'Accidente de trabajo' | 'Enfermedad profesional' | 'Accidente común',
