...
export default function NewGlobalUser() {
  ...
  return (
    <DashboardShell>
      <DashboardHeader
        heading="Nuevo Usuario Global"
        text="Crear un nuevo usuario en el sistema"
      >
      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              <Label htmlFor="tenant_id">Centro Médico (Opcional)</Label>
              <Input
                type="number"
                id="tenant_id"
                name="tenant_id"
                ...
                onChange={handleChange}
                placeholder="ID del centro médico"
              />
            </div>
          </div>
